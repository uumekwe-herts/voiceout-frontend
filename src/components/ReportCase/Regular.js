...
import caseReportValidation from '../../validation/caseReport';
...
const Regular = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setErrors(caseReportValidation(values, formatedDateOfIncident));
    const config = {
      headers:{
    ...
    formData.append('contact_first_name',values.contactFirstName);
    formData.append('contact_last_name',values.contactLastName);
    ...
    setIsLoading(true);
    axios.post(configData.SERVER_URL+"user/submitcase",formData,config)
    .then(response => {
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              ...
              <div class="w-full md:w-1/2 px-3">
                ...
                <input type="text" class="form-control block w-full px-4 py-2 font-normal text-gray-700 
                    ...
                    onChange={handleChange} 
                />
                {errors.contactLastName && <p class="text-red-600 text-xs"> {errors.contactLastName} </p>}
              </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label for="" class="form-label inline-block mb-2 text-gray-700">Contact Phone</label>
                <input type="text" class="form-control block w-full px-4 py-2 font-normal text-gray-700 
                    bg-white bg-clip-padding border border-solid border-gray-300 rounded transition 
                    ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    name="contactPhone"
                    ...
                    onChange={handleChange} 
                />
                {errors.contactPhone && <p class="text-red-600 text-xs"> {errors.contactPhone} </p>}
              </div>
              <div class="w-full md:w-1/2 px-3">
                <label for="" class="form-label inline-block mb-2 text-gray-700">Contact Email</label>
                <input type="text" class="form-control block w-full px-4 py-2 font-normal text-gray-700 
                    bg-white bg-clip-padding border border-solid border-gray-300 rounded transition 
                    ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    name="contactEmail"
